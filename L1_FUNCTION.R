...
L1_FUNCTION<-function(rep_dir,ins_dir,date_S){
  ...
  ss<-read.dta13(paste0(date_dir,"/","MODULO_L1.dta"))#,generate.factors=T,convert.factors = T,convert.dates = T,missing.type = F,replace.strl=T);gc()
...
#     cf<-t(Subset(ss[ii,],"l5_25a_"))
    ...
    to_check<-list(ID,aaa,a,b,c,d,e,f,g,h,i,j,k,kk,l,m,n,o,p,q,qq,r,s,t,u,v,w,x,y,z,aa,ab,ac,ad,ae,af,ag,ah)#,ai,aj,ak,al,am,an,ao,ap,ar,as,at,au,av,aw,aww,ax,ay,az,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,bn,bo,bp,bq,br,bs,bt,bu,bv,bw,bx,by,bz,ca,cb,cc,cd,ce,cf)
    to_check<-do.call(cbind,to_check)
    rm(ID,aaa,a,b,c,d,e,f,g,h,i,j,k,kk,l,m,n,o,p,q,qq,r,s,t,u,v,w,x,y,z,aa,ab,ac,ad,ae,af,ag,ah)#,ai,aj,ak,al,am,an,ao,ap,ar,as,at,au,av,aw,aww,ax,ay,az,ba,bb,bc,bd,be,bf,bg,bh,bi,bj,bk,bl,bm,bn,bo,bp,bq,br,bs,bt,bu,bv,bw,bx,by,bz,ca,cb,cc,cd,ce,cf)
...
#                   "L.5 ¿Cuales (Especificar)?" 
  ...
  write.xlsx (M_B,paste0(date_dir,"/","MODULO_L1",".xls"),row.names=F,showNA = F)
  save(M_B,file=paste0(date_dir,"/","MODULO_L1",".RData"))
...
#x<-L1_FUNCTION(rep_dir,ins_dir,date_S)
